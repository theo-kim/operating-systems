...
main(void) {
   ...
   9:	c7 44 24 04 c3 07 00 	movl   $0x7c3,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 e2 03 00 00       	call   3ff <printf>
	exit();
  1d:	e8 66 02 00 00       	call   288 <exit>
  22:	90                   	nop
  23:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 396:	0f b6 90 14 0a 00 00 	movzbl 0xa14(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4f5:	75 27                	jne    51e <printf+0x11f>
          s = "(null)";
 4f7:	c7 45 f4 d0 07 00 00 	movl   $0x7d0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c3:	a1 30 0a 00 00       	mov    0xa30,%eax
...
free(void *ap)
{
 ...
 684:	a3 30 0a 00 00       	mov    %eax,0xa30
}
 689:	c9                   	leave  
 68a:	c3                   	ret    
